...
const UUID = process.env.UUID || '00fda29c-8089-482b-87da-09935d5777dc'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.dyhdg.tk';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZWU2ZTI0MWExM2RkNjIzZDQ5YzIyMTJiNmQ0YjZjYWMiLCJ0IjoiMDgyODgwMjctNThkZS00YzNlLWFkZjctOTM0Y2I5NTgwNzQxIiwicyI6Ill6ZG1OVEV3TXpndFltWXhNaTAwTkRGbUxUZzVNekl0TW1ZMU9HWTJNRGN6WkROaiJ9';
const CFIP = process.env.CFIP || 'visa.com.sg';
